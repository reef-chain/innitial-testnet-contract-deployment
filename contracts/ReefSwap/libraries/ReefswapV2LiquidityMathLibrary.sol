...
library ReefswapV2LiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        (reserveA, reserveB) = ReefswapV2Library.getReserves(
            factory,
            tokenA,
            tokenB
        );
        ...
        require(
            ...
            "ReefswapV2ArbitrageLibrary: ZERO_PAIR_RESERVES"
        );
        ...
        if (aToB) {
            uint amountOut = ReefswapV2Library.getAmountOut(
                amountIn,
                reserveA,
                reserveB
            );
    ...
    function getLiquidityValue(
        ...
        (uint256 reservesA, uint256 reservesB) = ReefswapV2Library.getReserves(
            factory,
            tokenA,
            tokenB
        );
        IReefswapV2Pair pair = IReefswapV2Pair(
            ReefswapV2Library.pairFor(factory, tokenA, tokenB)
        );
